...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A loading indicator component with multiple variants and accessibility features.',
      },
    },
  },
  tags: ['autodocs'],
  ...
  render: () => (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center">
      <div className="text-center">
        ...
        <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Spinner</p>
      </div>
      <div className="text-center">
        <Loader variant="dots" />
  ...
  render: () => (
    <div className="space-y-6">
      ...
      <div className="p-4 border border-slate-200 dark:border-slate-700 rounded-lg">
        <h3 className="text-sm font-medium mb-3">Button Loading State</h3>
        <button className="px-4 py-2 bg-blue-600 text-white rounded-md disabled:opacity-50 flex items-center gap-2" disabled>
      ...
      <div className="p-6 border border-slate-200 dark:border-slate-700 rounded-lg">
        <h3 className="text-sm font-medium mb-4">Card Loading State</h3>
      ...
      {/* Page loading state */}
      <div className="p-6 border border-slate-200 dark:border-slate-700 rounded-lg">
        <h3 className="text-sm font-medium mb-4">Page Loading State</h3>
