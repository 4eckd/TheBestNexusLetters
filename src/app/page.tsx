...
const mockTestimonials = [
  {
    ...
    title: 'Army Veteran',
    company: null,
    content: 'The Best Nexus Letters helped me get the documentation I needed for my VA claim. Professional, thorough, and compassionate service.',
    rating: 5,
    avatar_url: null,
    featured: true,
    active: true,
  ...
  },
  {
    ...
    title: 'Navy Veteran',
    company: null,
    content: 'Outstanding service and fast turnaround. The nexus letter was comprehensive and exactly what my lawyer needed.',
    rating: 5,
    avatar_url: null,
    featured: true,
    active: true,
  ...
  },
  {
    ...
    company: null,
    content: 'Professional team that understands the VA process. They made everything clear and easy to understand.',
    rating: 5,
    avatar_url: null,
    featured: true,
    active: true,
...
export default function Home() {
  return (
    <div className="bg-background">
      ...
      <Suspense fallback={<div className="py-16 text-center"><Loader /></div>}>
        <Testimonials 
